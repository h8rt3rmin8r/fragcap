...
- [Action outcome](command-line-and-diagnostics.md#action-outcome)
...
- [Artifact identity](platform-and-distribution.md#artifact-identity)
...
- [Authorization plan](command-line-and-diagnostics.md#authorization-plan)
- [Backpressure](capture-and-networking.md#backpressure)
- [Binary marker](anti-cheat-and-security.md#binary-marker)
...
- [Capture mode](capture-and-networking.md#capture-mode)
...
- [Compatibility line](platform-and-distribution.md#compatibility-line)
...
- [Detection signature](anti-cheat-and-security.md#detection-signature)
...
- [Doctor probe](command-line-and-diagnostics.md#doctor-probe)
...
- [Finite dependency exception](platform-and-distribution.md#finite-dependency-exception)
...
- [Heartbeat line](command-line-and-diagnostics.md#heartbeat-line)
- [Hero listing](command-line-and-diagnostics.md#hero-listing)
...
- [Installer effect](platform-and-distribution.md#installer-effect)
...
- [Launch-and-observe](process-and-attribution.md#launch-and-observe)
...
- [Lifecycle case](platform-and-distribution.md#lifecycle-case)
...
- [Lifecycle stream](file-and-wire-formats.md#lifecycle-stream)
- [Link type](capture-and-networking.md#link-type)
- [Listing snapshot](command-line-and-diagnostics.md#listing-snapshot)
- [Live status block](command-line-and-diagnostics.md#live-status-block)
...
- [Native residue inventory](capture-and-networking.md#native-residue-inventory)
- [Non-profile capture path](process-and-attribution.md#non-profile-capture-path)
- [npcap](platform-and-distribution.md#npcap)
- [Observed socket-holder](process-and-attribution.md#observed-socket-holder)
...
- [Package certification](platform-and-distribution.md#package-certification)
- [Package contract](platform-and-distribution.md#package-contract)
- [Package entry](platform-and-distribution.md#package-entry)
...
- [Protocol classification](capture-and-networking.md#protocol-classification)
- [Provenance](process-and-attribution.md#provenance)
- [Provider](process-and-attribution.md#provider)
- [Proxy bypass policy](capture-and-networking.md#proxy-bypass-policy)
...
- [Raw proxy observation](capture-and-networking.md#raw-proxy-observation)
- [Readiness check](command-line-and-diagnostics.md#readiness-check)
- [Redraw](command-line-and-diagnostics.md#redraw)
- [Refresh trigger](process-and-attribution.md#refresh-trigger)
- [Release build identity](platform-and-distribution.md#release-build-identity)
...
- [Sensitivities](command-line-and-diagnostics.md#sensitivities)
...
- [Software bill of materials](platform-and-distribution.md#software-bill-of-materials)
...
- [Staggered connection race](capture-and-networking.md#staggered-connection-race)
...
- [Structured action](command-line-and-diagnostics.md#structured-action)
- [Superseded alias](process-and-attribution.md#superseded-alias)
- [Supply-chain gate](platform-and-distribution.md#supply-chain-gate)
...
- [Target-entry export](command-line-and-diagnostics.md#target-entry-export)
...
- [Terminal report](command-line-and-diagnostics.md#terminal-report)
- [Terminal stage](process-and-attribution.md#terminal-stage)
- [Test tier](rust-and-tooling.md#test-tier)
- [Third-party notices](platform-and-distribution.md#third-party-notices)
- [Threat registry](capture-and-networking.md#threat-registry)
...
- [Trust boundary](capture-and-networking.md#trust-boundary)
- [Unresolved launch chain](process-and-attribution.md#unresolved-launch-chain)
