...
Deep Capture is functional but incomplete. This page describes the native bundle contract shipped in v0.10.0 on 2026-09-15, not independent security approval or final [#334 acceptance](https://github.com/h8rt3rmin8r/fragcap/issues/334). S151 changes no artifact schema or retained observation contract.
