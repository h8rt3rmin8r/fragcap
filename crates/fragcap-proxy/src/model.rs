...
impl Default for ProtocolLimits {
    fn default() -> Self {
        Self {
            ...
            max_quic_connections: 64,
            max_quic_datagrams: 1024,
...
impl ProtocolLimits {
    pub(crate) fn validate(&self) -> Result<(), ConfigError> {
        let nonzero = [
            ...
            ("max-quic-connections", self.max_quic_connections),
            ("max-quic-datagrams", self.max_quic_datagrams),
        ];
...
pub struct ProtocolAccounting {
    ...
    pub generic_streams_plain: u64,
    pub generic_streams_tls_opaque: u64,
    pub generic_streams_tls_intercepted: u64,
    pub generic_stream_bytes_observed: u64,
    pub generic_stream_bytes_retained: u64,
    pub generic_stream_bytes_omitted: u64,
    pub generic_stream_bytes_queue_dropped: u64,
    pub generic_udp_datagrams_observed: u64,
    pub generic_udp_bytes_observed: u64,
    pub generic_udp_bytes_retained: u64,
    pub generic_udp_bytes_omitted: u64,
    pub generic_udp_datagrams_truncated: u64,
    ...
    pub generic_udp_socket_errors: u64,
    pub quic_pairs_started: u64,
    pub quic_pairs_completed: u64,
    pub quic_pairs_refused: u64,
    pub quic_streams: u64,
    pub quic_stream_bytes_observed: u64,
    pub quic_stream_bytes_retained: u64,
    pub quic_stream_bytes_omitted: u64,
    pub quic_datagrams: u64,
    ...
    pub quic_transport_losses: u64,
    pub quic_zero_rtt_refused: u64,
    pub quic_migration_refused: u64,
    pub http3_streams: u64,
    pub http3_streams_completed: u64,
    pub http3_streams_reset: u64,
