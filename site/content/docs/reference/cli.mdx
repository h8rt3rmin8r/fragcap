...
This page describes the public v0.7.0 command tree. Its command headings,
...
that the current CLI no longer accepts. Use these replacements with v0.7.0:
...
reported, but v0.7.0 still writes both directions.
