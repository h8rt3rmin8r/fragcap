...
These instructions describe the current v0.8 external-backend path. S102 adds
a native bounded-runtime foundation, but native protocol inspection and CLI
