...
below use external mitmdump, with trust effects provided by native Windows APIs.
S103 completes the native Rust security and protocol-lab foundation without
switching production inspection. [Issue #278](https://github.com/h8rt3rmin8r/fragcap/issues/278)
...
controlled lab for every required protocol family. Protocol fidelity (#292 through #305), launch and
