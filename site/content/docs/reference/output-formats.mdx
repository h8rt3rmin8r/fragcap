...
Deep Capture is functional but incomplete. This page describes the native bundle contract shipped in v0.10.0 on 2026-09-15, not independent review #333, installed retest #413, documentation reconciliation #331, final gate #334 or epic #278 acceptance. S151 changes no artifact schema or retained observation contract; the [Native product contract](/docs/reference/native-documentation) owns the complete status boundary.
