...
These instructions describe guided calibration and native functionality shipped in v0.10.0 on 2026-09-15. Deep Capture is functional but incomplete: independent review #333, Doctor field validation #372, documentation reconciliation #331, final gate #334 and epic #278 remain open. Follow documentation matching your installed bytes; v0.10.2 includes the complete S154 through S158 native documentation, review-intake and deterministic certification engineering. The [Native product contract](/docs/reference/native-documentation) records the exact boundary.
</Callout>
