...
Deep Capture is functional but incomplete. Native protocol, managed launch, scoped routing, bounded evidence, recovery, packaging, stable API, and guided calibration work has landed through S149. S150 prepares v0.10.0 documentation and an independent-review handoff, not a completed audit or published release. [Issue #278](https://github.com/h8rt3rmin8r/fragcap/issues/278) owns the completion contract; [#334](https://github.com/h8rt3rmin8r/fragcap/issues/334) is the final gate.
</Callout>
