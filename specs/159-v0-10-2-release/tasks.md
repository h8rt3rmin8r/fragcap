...
- [x] T017 [US1] Observe every first-round review and hosted check, address all findings, reply and resolve every thread.
- [x] T018 [US1] Request at most one second Codex review if needed, address all resulting findings and require every final-head check green.
- [x] T019 [US1] Ask the owner for the mandatory human merge only after candidate review and CI are complete.

## Phase 4: Public release

- [x] T020 [US2] After merge, sync clean main and verify exact local, remote and merged-candidate identity.
- [x] T021 [US2] Verify no conflicting v0.10.2 tag exists, create the tag at exact merged source and push it.
- [x] T022 [US2] Monitor identity, package certification and GitHub release jobs without blind reruns or policy changes.
- [x] T023 [US2] If the publish job waits, request the owner's protected-environment approval and continue after it is supplied.
- [x] T024 [US2] Require all four release jobs green and record exact run, job and approval evidence.
- [x] T025 [US2] Verify the public non-draft release and six expected file names, sizes and SHA-256 digests without installing or executing them.
- [x] T026 [US2] Validate all three checksum sidecars and the downloaded certification summary against the exact tag source.
- [x] T027 [US2] Verify all ten crates at 0.10.2 are available, non-yanked and carry registry checksums.

## Phase 5: Published-record reconciliation

- [x] T028 [US3] Create a separate `codex/s159-v0-10-2-publication-record` branch from exact post-release main.
- [x] T029 [US3] Update published-release JSON, current baseline markers, review candidate identity, release handoff and S159 verification with observed evidence.
- [x] T030 [US3] Preserve historical v0.10.1 evidence and keep #372, #333, #334 and #278 open with accurate scope.
- [x] T031 [US3] Run records-focused and full repository gates, text-integrity checks and published-site validation.
