...
These instructions include guided calibration and native functionality through S149, prepared for v0.10.0 by S150. v0.9.0 remains the published baseline until operator publication. Deep Capture is functional but incomplete: independent review [#333](https://github.com/h8rt3rmin8r/fragcap/issues/333) and final gate [#334](https://github.com/h8rt3rmin8r/fragcap/issues/334) remain open. Follow documentation matching your installed bytes.
</Callout>
