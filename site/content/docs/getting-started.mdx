...
These instructions describe the S105 native HTTP/1.1, HTTP/2, CONNECT, HTTPS,
metadata, bounded body, and live application-stream path.
Broader protocol, launch, transport, artifact, recovery, and completion work
remains tracked under [#278](https://github.com/h8rt3rmin8r/fragcap/issues/278).
</Callout>
...
Deep Capture
  proxy backend          ok    fragcap-native 0.8.0
