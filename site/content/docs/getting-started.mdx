...
These instructions describe guided calibration and native functionality shipped in v0.10.0 on 2026-09-15. Deep Capture is functional but incomplete: independent review #333, installed retest #413, documentation reconciliation #331, final gate #334 and epic #278 remain open. Follow documentation matching your installed bytes; v0.10.1 adds S151 Doctor diagnostics and S152 publication protection. The [Native product contract](/docs/reference/native-documentation) distinguishes that release from later current-source engineering.
</Callout>
