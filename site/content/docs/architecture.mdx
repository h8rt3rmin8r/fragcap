...
Deep Capture is functional but incomplete. Native protocol, managed launch, scoped routing, bounded evidence, recovery, packaging, stable API, guided calibration and S150 documentation shipped in v0.10.0 on 2026-09-15. The independent-review handoff is readiness, not a completed audit. [Issue #278](https://github.com/h8rt3rmin8r/fragcap/issues/278) owns the completion contract; [#334](https://github.com/h8rt3rmin8r/fragcap/issues/334) is the final gate.
</Callout>
