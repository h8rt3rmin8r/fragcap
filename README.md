...
v0.10.1 publishes S151 Doctor diagnostics and S152 owner-controlled registry protection, with certified Windows packages and all ten crates at 0.10.1. S150's independent-review handoff remains readiness, not an installed-build audit. Use digest-verified published bytes for optional operator testing; independent review and final acceptance remain open.
