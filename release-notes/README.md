...
4. Run `cargo xtask notes X.Y.Z` before creating the release tag. The command fails when the file is absent, malformed, hard-wrapped, copied or excerpted from the changelog, longer than 1,400 characters, or longer than 12 non-empty lines.
