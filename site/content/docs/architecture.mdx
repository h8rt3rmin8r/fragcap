...
Deep Capture is functional but incomplete. Native protocol, managed launch, scoped routing, bounded evidence, recovery, packaging, stable API, guided calibration and S150 documentation shipped in v0.10.0 on 2026-09-15. The independent-review handoff is readiness, not a completed audit. Independent review #333, installed retest #413, documentation reconciliation #331, final gate #334 and epic #278 remain open. The [Native product contract](/docs/reference/native-documentation) keeps those authorities separate.
</Callout>
