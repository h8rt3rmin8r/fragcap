...
- **FR-002**: The plan MUST identify the session, exact stored target, observed and requested launch case, target-scoped proxy routing and bypass policy, loopback address family, bundle destination, requested sensitive outputs, effective deadlines, product and backend versions, cleanup obligations, important refusal boundaries, and possible compatibility fact writes.
