...
```text
pwsh -NoLogo -NoProfile -NonInteractive -File scripts/Test-PackageCertification.ps1 -ArtifactDirectory dist -PredecessorPath target/package-certification/fragcap-0.8.0-x86_64.msi -ReportPath target/package-certification/report.json -Confirm:$false
cargo xtask package-certification validate-report target/package-certification/report.json dist
```
