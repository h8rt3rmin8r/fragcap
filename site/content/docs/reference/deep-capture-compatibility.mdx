...
This matrix describes native protocols, final-package certification, stable API and guided calibration shipped in v0.10.0 on 2026-09-15. Independent whole-product review [#333](https://github.com/h8rt3rmin8r/fragcap/issues/333) and the final completion gate [#334](https://github.com/h8rt3rmin8r/fragcap/issues/334) remain outstanding. Controlled conformance and packaging evidence are not a universal title-compatibility claim.
</Callout>
