...
technology evidence; with `--db`, register what is found.
...
| `--db` | open | none | all | Select a local store to register discoveries into; omission leaves the scan read-only. |
