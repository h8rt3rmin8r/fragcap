...
pub mod targets {
    ...
    pub use fragcap_targets::{
        ...
        AutomaticRegistrationOutcome, CaptureReadiness, CatalogBatch, CatalogEntry, CatalogSource,
        ...
        PlatformInventory, ReconciliationPlan, ReconciliationPreservationReason,
        ReconciliationRemovalReason, RegistrationOutcome, ResolvedEngine, SeedState, SeedSummary,
