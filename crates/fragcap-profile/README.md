...
Game profile schema, parsing, and stage matching for fragcap.
...
A profile describes how a title is launched and which stage of a launcher
chain owns the socket, so that attribution has something declarative to match
against rather than a hardcoded table.
