...
Follow documentation matching the installed published version. v0.10.1 is published with certified ZIP/MSI/catalog downloads and all ten crates at 0.10.1. Release tags and registry publication require explicit operator authority; a source checkout or candidate build is not the requested published operator test surface. S151 Doctor diagnostics are included in v0.10.1 for optional operator-owned installed testing.
