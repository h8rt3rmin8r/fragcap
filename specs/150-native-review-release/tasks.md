...
**Independent Test**: Deterministic writer checks plus two fresh fixed-code Windows short campaigns under unchanged S128 workload, limits, and comparability authority.
