...
2 application stream. WebSocket, SSE, gRPC, TLS key logs, client certificates,
HAR, correlation, launch and transport coverage, and final completion remain open.
