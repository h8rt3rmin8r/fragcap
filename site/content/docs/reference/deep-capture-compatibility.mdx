...
This matrix describes native protocols, final-package certification, stable API and guided calibration shipped in v0.10.0 on 2026-09-15. Independent review #333, installed retest #413, documentation reconciliation #331, final gate #334 and epic #278 remain outstanding under the [Native product contract](/docs/reference/native-documentation). Controlled conformance and packaging evidence are not a universal title-compatibility claim.
</Callout>
