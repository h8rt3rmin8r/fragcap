...
pub mod targets {
    ...
    pub use fragcap_targets::{
        ...
        is_row_index, launch_entries_for, launch_entry_value, launch_is_unresolved,
        name_divergence, observed_executable, plan_reconciliation, register_automatic_candidates,
