...
The [native threat model](https://github.com/h8rt3rmin8r/fragcap/blob/main/docs/security/deep-capture-threat-model.md), closed dependency policy, parser fuzz inventory, controlled failure matrix, conformance, and package certification provide reproducible engineering evidence. S150 adds the [independent-review handoff](https://github.com/h8rt3rmin8r/fragcap/blob/main/docs/security/native-product-review-handoff.md), not an independent audit verdict. Independent review #333, Doctor field validation #372, documentation reconciliation #331, final gate #334 and epic #278 remain open under the [Native product contract](/docs/reference/native-documentation).
