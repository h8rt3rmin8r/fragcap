...
Follow documentation matching the installed published version. v0.10.0 was published on 2026-09-15 with certified ZIP/MSI/catalog downloads and all ten crates at 0.10.0. Release tags and registry publication require explicit operator authority; a source checkout or candidate build is not the requested published operator test surface. S151 Doctor diagnostics require a later authorized release before installed testing.
