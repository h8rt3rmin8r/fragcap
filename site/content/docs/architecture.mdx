...
Deep Capture is functional but incomplete. S104 makes native HTTP/1.1, CONNECT,
and HTTPS inspection the sole production proxy path, with trust effects provided
by native Windows APIs. [Issue #278](https://github.com/h8rt3rmin8r/fragcap/issues/278)
...
CONNECT, and separately verified HTTPS. Broader protocol fidelity (#294 through
#305), launch and transport coverage (#306 through #318), and final completion remain open.
